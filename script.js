const build = [
    ...
    ["TT","October 5th, 2024 - The journey started right as I woke up, made some coffee, and went to sit on the couch.","stop.kms"],
    ["Pic2", "", "assets/images/IMG_1283.webp","assets/images/IMG_1274.webp","assets/sounds/Dog walking edit.mp3"],
    ["PicL", "", "assets/images/IMG_2872.webp", "Question 1 - Do you have a pet? Why did you get them? What is your relationship to them?", "I sat down and instantly my dog comes over to me for attention. It is a joke in my house how Miya is like my shadow. She follows me everywhere I go whenever I am home. I still remember when we first got her, it was a year after our previous dog suddenly passed away. Our family always had dogs, and after the passing of our previous dog Maggy, we ended up fostering dogs for a while. We grew to love pitbull labs as they were the most loving, calm, yet playful breed we ever fostered. This led us to eventually get Miya as just a puppy. Her head and paws  were too big for her body at the time and every time she would run around she would end up doing a front flip, but this never stopped her. Nowadays she is less energetic, yet she still will always be right at my side no matter what.","assets/sounds/Dog walking edit.mp3"],
    ["PicR", "", "assets/images/IMG_1278.webp","In House Vine", "While I was sitting on the couch with my dog, I noticed the tall vine that my mom brought home one day and takes care of. ","stop.kms"],
    ...
    ["PicR", "", "assets/images/IMG_1279.webp", "", "On the way outside my house, I ended up seeing another plant sitting on a windowsill."],
    ["PicL", "", "assets/images/IMG_1280.webp", "", "Saw this Picture of all bird types in New Jersey in my house. It's strange how you don't notice something your whole life."],
    ["TT", "After looking at the house plants and reading about the birds, I got the urge to go outside and really enjoy nature. On my way, I ended up seeing some unknown visitors...", " ","assets/sounds/Outside house.mp3"],
    ["Pic2", "", "assets/images/IMG_1284.webp", "assets/images/IMG_1277.webp", "", ],
    ["TTs", 'Question 3 - When uninvited animals, often referred to as "pests," come into your home, do you ever think of them as nature?', `When uninvited animals or “pests” come into my house, I often do think of them as nature, but depending on the animal, I may not treat it as nature. Things such as mice, ladybugs, stink bugs, moths, ants, flys, rolly pollies, and roaches, I do my best not to kill and instead will either leave them be, or capture them and bring them outside. HOWEVER, when it comes to spiders, I do not mess around and am terrified of them, and it doesn't help that we get them all the time in my home. Whenever I see one I freak and half the time, I don't even have the guts to go and kill them. There was a time I didn't sleep in my own bedroom for 2 weeks cause I saw a huge spider and it crawled under my bed before I could kill it. So in short, I do think of them all as nature, I just don't treat spiders with any respect as I do other pests.`],
    ["PicL", "", "assets/images/IMG_1285.webp", "Backyard Buddy","Stepping into my backyard, I noticed a little friend moving through the tall, uncut grass. I realized how much I consider my yard as nature. There are always animals running about, and my dog plays and chases squirrels and groundhogs. It's my own little piece of nature that I love and enjoy."],
    ["Pic2", "","assets/images/IMG_0865.webp","assets/images/IMG_1098.webp", "assets/sounds/Outside house.mp3"],
    ...
    ["Pic2", "","assets/images/IMG_1268.webp", "assets/images/IMG_1269.webp",""],
    ["PicL", "", "assets/images/IMG_1268.webp", "Yet it ran dry.", " "],
    ["PicL", "", "assets/images/IMG_1265.webp", "So off I went.", " "],
    ["cen", "","assets/images/IMG_1267.webp"],
    ["cen", "", "assets/images/IMG_1270.webp"],
    ...
    ["Pic2", "assets/images/IMG_1271.webp", "assets/images/IMG_1272.webp"],
    ...
    ["PicL", "", "assets/images/IMG_1249.webp", "Some going through life alone.", " "],
    ["PicR", "", "assets/images/IMG_1258.webp", "And some with a friend by their side.", " "],
    ["PicL", "", "assets/images/IMG_1255.webp","Some young and so full of potential.", " "],
    ["TT", "Others not so much."],
    ["cen", "","assets/images/IMG_1254.webp"],
    ["TT", "Yet they all lived amongst eachother."],
    ["PicL", "", "assets/images/IMG_1259.webp", "Without a care in the world.", ""],
    ["TT", "As if knowing one another."],
    ["Pic2", "", "assets/images/IMG_1256.webp", "assets/images/IMG_1257.webp"],
    ["TT", "No matter the species"],
    ["Pic2", "", "assets/images/IMG_1263.webp", "assets/images/IMG_1261.webp"],
    ["TT", "Some even coming and helping out."],
    ["cen", "", "assets/images/IMG_1264.webp"],
    ["TT", "No matter who,"],
    ["TT", "or what,"],
    ["TT", "or where you are..."],
    ["TT", "Everything in life comes from the same place."],
    ["cen", "", "assets/images/IMG_1266.webp"],
    ["PicL", "", "assets/images/IMG_1266.webp","","For my representation of nature, I chose everyones favorite: a tree. this one in particular, is the massive tree that stands tall and proud in the center of the park. The reason for this is the vital role that trees truly play in not just humans, but every other living thing in the world. It allows life to even exist, by giving us oxygen to breathe, and yet everyday they are taken for granted by nearly all living things."]
